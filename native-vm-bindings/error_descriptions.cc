...
std::map<mvm_TeError, std::string> errorDescriptions = {
  ...
  { MVM_E_MALLOC_MUST_RETURN_POINTER_TO_EVEN_BOUNDARY, "MVM_E_MALLOC_MUST_RETURN_POINTER_TO_EVEN_BOUNDARY" },
  ...
  { MVM_E_TDZ_ERROR, "The script tried to access a local variable before its declaration" },
  { MVM_E_MALLOC_RETURNS_WRONG_HIGH_BITS, "See instructions in example port file at the defitions MVM_USE_SINGLE_RAM_PAGE" },
};
